...
export default function Planned() {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-8 md:p-16 h-screen flex flex-col">
      <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 sm:mb-6 p-2 sm:p-4 text-white pt-16">Planned</h1>
      ...
      {isLoading ? (
        ...
        <div className="bg-gray-800 rounded-lg py-6 sm:py-12 px-3 sm:px-4 text-center mt-4 sm:mt-8">
          <p className="text-gray-400 text-base sm:text-lg">No planned tasks</p>
